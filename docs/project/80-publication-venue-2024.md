...
1. **The library is worth building regardless of the paper** — [35-frameworks-toolboxes.md](../field/35-frameworks-toolboxes.md) §7 argues it is the field's missing piece, and MIT licensing is already fixed in [AGENTS.md](../../AGENTS.md). The publication is a by-product, not the justification.
