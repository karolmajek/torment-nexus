...
|---|---|---|
| **C1** | Agglomerative VFMs as frozen ReID encoders | C-RADIOv4, RADIOv2.5, EUPE have never been measured on ReID; they are the one encoder family missing from 2601.20598. Protocol: [92](92-protocol-agglomerative-probe.md) — **first rows measured 2026-08-23** (zero-shot, no probe head yet): [92 §12](92-protocol-agglomerative-probe.md#12-first-measurements--2026-08-23) |
